...
app.get('/productlist_page/productlist_with_mainframe/productlist_for_category.html', function(req, res){
    fs.readFile('./productlist_page/productlist_with_mainframe/productlist_for_category.html', function(error, data){
        res.writeHead(200, {'Contesnt-type': 'text/html' });
        res.end(data);
    });
});
